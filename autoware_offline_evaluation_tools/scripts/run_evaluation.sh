...
# Usage: ./run_evaluation.sh <result_bag_path> <input_bag_path> <trajectory_topic> <output_dir>

set -e

if [ $# -lt 4 ]; then
    echo "Usage: $0 <result_bag_path> <input_bag_path> <trajectory_topic> <output_dir>"
    echo ""
    echo "Arguments:"
